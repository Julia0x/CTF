...
public class BlockTrackingManager {
    ...
    private final Set<Material> TRACKABLE_BLOCKS = Set.of(
        ...
        Material.SANDSTONE, Material.WOOD, Material.PLANKS, Material.WOOL,
        ...
        Material.STONE_BRICK, Material.NETHER_BRICK, Material.END_STONE,
        ...
        Material.CONCRETE, Material.GLAZED_TERRACOTTA, Material.SHULKER_BOX,
        Material.LADDER, Material.VINE, Material.TORCH, Material.REDSTONE_TORCH,
        Material.LEVER, Material.STONE_BUTTON, Material.PRESSURE_PLATE,
        Material.FENCE, Material.FENCE_GATE, Material.DOOR, Material.TRAPDOOR,
        Material.CHEST, Material.FURNACE, Material.CRAFTING_TABLE, Material.ANVIL,
        Material.ENCHANTMENT_TABLE, Material.BREWING_STAND, Material.CAULDRON
    );
